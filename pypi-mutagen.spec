...
Source0  : https://files.pythonhosted.org/packages/81/e6/64bc71b74eef4b68e61eb921dcf72dabd9e4ec4af1e11891bbd312ccbb77/mutagen-1.47.0.tar.gz
...
%prep
%setup -q -n mutagen-1.47.0
cd %{_builddir}/mutagen-1.47.0
pushd ..
cp -a mutagen-1.47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693932603
